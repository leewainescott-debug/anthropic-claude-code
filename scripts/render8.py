...
doc.append("<h1>TDD Cost Calc v8 (preview)</h1>")
doc.append('<div class="meta">Faithful render of the workbook cells &amp; formatting • generated '+datetime.date.today().isoformat()+'</div>')
import sys
PAGES = {
 "exec":   [("Exec Summary", 46, 7)],
 "port":   [("1.1 Ampol Retail", 62, 10), ("1.11 TDD Cyber", 42, 10)],
 "group":  [("2.0 Group Summary", 42, 10), ("2.1 Total Cost", 58, 7)],
 "coe":    [("2.2 COE", 30, 8), ("2.3 BP&T", 46, 11)],
 "sadcyb": [("2.4 SA&D", 56, 11), ("2.5 Cyber Roles", 74, 11)],
 "fte":    [("3.0 FTE View", 172, 15)],
 "gm":     [("4.1 GM Ampol Retail", 80, 10), ("4.11 GM TDD Cyber", 70, 10)],
}
